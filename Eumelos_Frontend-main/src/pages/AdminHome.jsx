...
const AdminHome = () => {
  ...
  const handleDeleteCourse = async (courseId) => {
    if(!window.confirm("Sure you want to delete this course? All enrollments linked to it will be removed too.")) return;
    ...
    <div className="admin-home">
      <div className="admin-banner glass-panel">
        <div className="banner-content">
          ...
          <p>Quick stats and tools to keep things running.</p>
        </div>
